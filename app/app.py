...
settings_page = st.Page("app_pages/settings.py", title="Settings", icon=":material/settings:", default=True)
data_refresh_page = st.Page("app_pages/data_refresh.py", title="Data Refresh", icon=":material/refresh:")
